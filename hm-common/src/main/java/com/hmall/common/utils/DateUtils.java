...
public class DateUtils extends LocalDateTimeUtil {
    ...
    public static LocalDateTime getUTCTime(LocalDateTime localDateTime) {
        var australia = ZoneId.of("Asia/Shanghai");
        var dateAndTimeInSydney = ZonedDateTime.of(localDateTime, australia);
        var utcDate = dateAndTimeInSydney.withZoneSameInstant(ZoneOffset.UTC);
    ...
    public static LocalDateTime getAsiaTime(LocalDateTime localDateTime) {
        var australia = ZoneId.of("Asia/Shanghai");
        var dateAndTimeInSydney = ZonedDateTime.of(localDateTime, ZoneOffset.UTC);
        var utcDate = dateAndTimeInSydney.withZoneSameInstant(australia);
        return utcDate.toLocalDateTime();
    }
    ...
    public static Date addDays(int i) {
        var c = Calendar.getInstance(TimeZone.getTimeZone(TIME_ZONE_8));
    ...
    public static int getDay(LocalDateTime localDateTime) {
        ...
        var dateStr = format(localDateTime, DEFAULT_DATE_FORMAT_COMPACT);
        return NumberUtils.parseInt(dateStr);
    }
    ...
    public static Long getFormatDate(LocalDateTime localDateTime, String format) {
        var date = format(localDateTime, format);
    ...
    public static LocalDateTime getMin(LocalDateTime... localDateTimes) {
        ...
        var localDateTimeList = Arrays.asList(localDateTimes);
